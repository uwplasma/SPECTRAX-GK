#!/usr/bin/env python3
"""Generate a VMEC-derived ``*.eik.nc`` file from a SPECTRAX runtime TOML."""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Generate VMEC geometry from a runtime TOML config.")
    ...
    out = generate_runtime_vmec_eik(cfg, output_path=args.out, force=bool(args.force))
    print(out)
    return 0
