...
from tools.write_vmec_boundary_perturbation_inputs import _coefficient_value  # noqa: E402
from tools.write_vmec_boundary_perturbation_inputs import _parse_coefficient_spec  # noqa: E402
from tools.write_vmec_boundary_perturbation_inputs import _patch_coefficient  # noqa: E402
...
def _metric_command(args: argparse.Namespace, *, input_path: Path, out_json: Path, outdir: Path, out_wout: Path) -> str:
    cmd = [
        "python3",
...
def build_campaign(args: argparse.Namespace) -> dict[str, Any]:
    ...
    manifest = {
        ...
        "common_random_number_policy": {
            ...
            "audit_window": [float(args.audit_window_tmin), float(args.audit_window_tmax)],
