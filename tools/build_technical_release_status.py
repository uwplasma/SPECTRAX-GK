...
LANES: dict[str, tuple[EvidenceCheck, ...]] = {
    ...
    "refactor_modularity": (
        ...
        EvidenceCheck("linear moments module", "src/spectraxgk/linear_moments.py"),
        EvidenceCheck("linear params module", "src/spectraxgk/linear_params.py"),
        EvidenceCheck("linear parallel module", "src/spectraxgk/linear_parallel.py"),
        EvidenceCheck("nonlinear helper module", "src/spectraxgk/nonlinear_helpers.py"),
        EvidenceCheck("benchmark scan module", "src/spectraxgk/benchmark_scan.py"),
        EvidenceCheck("diagnostics channel module", "src/spectraxgk/diagnostics_channels.py"),
        EvidenceCheck("coverage manifest", "tools/validation_coverage_manifest.toml", "spectraxgk.runtime_orchestration"),
    ),
