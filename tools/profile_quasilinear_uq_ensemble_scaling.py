...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--gradients", type=_parse_float_list, default=[2.15, 2.30, 2.45, 2.60, 2.75, 2.90, 3.05, 3.20])
    parser.add_argument("--ky", type=_parse_float_list, default=[0.12, 0.20, 0.28, 0.36, 0.44, 0.52])
