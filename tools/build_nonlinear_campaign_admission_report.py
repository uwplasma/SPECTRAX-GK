...
from spectraxgk.validation.stellarator.transport_campaign import (  # noqa: E402
...
DEFAULT_PRELAUNCH = ROOT / "docs/_static/vmec_boundary_transport_landscape_p0p03_prelaunch_gate.json"
DEFAULT_LANDSCAPE = ROOT / "docs/_static/vmec_boundary_transport_landscape_admission.json"
...
def main(argv: list[str] | None = None) -> int:
    ...
    policy = VMECJAXNonlinearCampaignPolicy(
        minimum_landscape_relative_reduction=float(args.min_landscape_relative_reduction),
        ...
        require_reduced_cross_sample_gate=not bool(args.allow_missing_cross_sample_gate),
    )
    report = build_report(
