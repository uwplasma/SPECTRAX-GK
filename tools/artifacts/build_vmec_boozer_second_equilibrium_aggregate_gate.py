...
from tools.artifacts.build_vmec_boozer_multi_point_objective_gate import (  # noqa: E402
    _float_tuple,
    _int_tuple,
    _sample_count,
    _surface_indices,
...
def _fail_closed_payload(
    *,
    ...
    return {
        ...
        "builder": "tools/artifacts/build_vmec_boozer_second_equilibrium_aggregate_gate.py",
        "passed": False,
        "feasible": False,
