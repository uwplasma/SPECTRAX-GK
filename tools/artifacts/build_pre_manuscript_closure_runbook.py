...
from tools.artifacts.build_pre_manuscript_closure_status import build_status_payload  # noqa: E402
...
DEFAULT_EXTERNAL_RUNBOOK = (
    ROOT / "docs" / "_static" / "external_vmec_next_holdout_runbook.json"
)
DEFAULT_HOLDOUT_GAP = ROOT / "docs" / "_static" / "quasilinear_holdout_gap_report.json"
DEFAULT_OPTIMIZER_MANIFEST = (
    ROOT / "docs" / "_static" / "vmec_jax_qa_optimizer_comparison_manifest.json"
)
DEFAULT_LADDER_STATUS = (
    ROOT / "docs" / "_static" / "vmec_jax_qa_optimizer_ladder_resume_status.json"
)
