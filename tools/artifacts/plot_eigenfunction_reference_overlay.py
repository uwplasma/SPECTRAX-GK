...
from spectraxgk.benchmarks import load_eigenfunction_reference_bundle
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "reference", type=Path, help="Frozen reference eigenfunction bundle (.npz)."
    )
    parser.add_argument(
        "spectrax", type=Path, help="SPECTRAX-GK eigenfunction CSV artifact."
    )
    parser.add_argument(
        "--out",
        type=Path,
