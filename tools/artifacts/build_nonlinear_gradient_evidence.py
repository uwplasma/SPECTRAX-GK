...
def _add_variance_parser(subparsers: argparse._SubParsersAction[argparse.ArgumentParser]) -> None:
...
def _add_control_mean_parser(
    ...
    parser.add_argument("--out-prefix", type=Path, default=DEFAULT_CONTROL_MEAN_OUT_PREFIX)
