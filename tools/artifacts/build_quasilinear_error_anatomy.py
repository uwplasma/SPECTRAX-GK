    ...
    for item in saturation.get("cases", []):
        ...
        if case:
            metadata[case] = {
                ...
                "observed_heat_flux_std": _finite_float(
        ...
        rows.append(
            {
                ...
                "pairwise_order_accuracy": _finite_float(
    ...
    *,
    ...
    for item in rows_in:
        ...
        row = {
            ...
            "prediction_interval_low": _finite_float(
                item.get("prediction_interval_low")
            ),
            "prediction_interval_high": _finite_float(
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        "--candidate-uncertainty", type=Path, default=DEFAULT_UNCERTAINTY
    )
