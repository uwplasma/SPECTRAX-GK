    ...
    return _json_clean(
        {
            ...
            "notes": (
                ...
                "The electrostatic field solve is still computed by the production serial field solver; this gate "
                "does not yet claim a sharded field-solve implementation."
            ),
        }
    )
