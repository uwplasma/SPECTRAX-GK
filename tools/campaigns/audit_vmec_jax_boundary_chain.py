...
from build_vmec_jax_transport_gradient_diagnostic import (
    _build_stage,
    _sample_set_from_args,
)  # noqa: E402
...
def main(argv: list[str] | None = None) -> int:
    ...
    frozen_axis_initial_fd_vs_linear = jax.block_until_ready(
        jnp.asarray(
            frozen_axis_initial_fd - frozen_axis_linear_tangent, dtype=jnp.float64
        )
    )
    ...
    result["summary"] = build_boundary_chain_summary(
        ...
        frozen_axis_linear_vjp_cost_gradient=result[
