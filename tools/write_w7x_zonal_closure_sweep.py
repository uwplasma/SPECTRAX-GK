...
def _command_for_case(
    ...
    *,
    ...
    if case.hypercollisions_const == 0.0 and case.hypercollisions_kz == 0.0:
        ...
        cmd.extend(_format_optional("--hypercollisions-const", case.hypercollisions_const))
...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--manifest", type=Path, default=DEFAULT_OUT_DIR / "w7x_zonal_closure_sweep_manifest.json")
