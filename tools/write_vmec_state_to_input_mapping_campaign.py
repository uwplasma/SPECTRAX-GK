...
DEFAULT_OUT_PREFIX = ROOT / "docs" / "_static" / "nonlinear_gradient_state_to_input_mapping_campaign"
...
def _unique_coefficients(coefficients: Sequence[CoefficientSpec]) -> tuple[CoefficientSpec, ...]:
