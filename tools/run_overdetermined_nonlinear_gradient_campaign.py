...
from tools.run_nonlinear_gradient_direct_campaign import (  # noqa: E402
    DirectTask,
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--control", action="append", default=None, help="Control slug to run; repeat to filter.")
