...
- 2026-07-14: Added the generalized-Laguerre monomial coefficients from Frei
  ...
  the 40-order cancellation growth reported in its Figure 1; implementation is
  therefore blocked on provenance review of the Jorge et al. (2019) closed
  formulas rather than an unsafe OCR transcription.
