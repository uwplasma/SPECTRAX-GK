...
- Current topology counts:
  - `src/spectraxgk`: 310 Python files after extracting nonlinear-gradient, nonlinear-transport, stellarator validation subpackages, benchmark case presets, and benchmark eigenfunction diagnostics.
...
- `src/spectraxgk/validation`: 35 installable benchmark-validation files.
...
case presets, and benchmark eigenfunction diagnostics:

| Area | Files / lines | Main issue |
| --- | ---: | --- |
| `src/spectraxgk` | 310 Python files, about 101.8k LOC | installable package still contains benchmark validation policy plus many public/internal facades |
| `src/spectraxgk/validation` | 35 Python files, about 16.9k LOC | benchmark validation policy is still installed as runtime code |
...
| --- | ---: | --- | --- |
| `validation.benchmarks` | 34 files, about 16.9k LOC | benchmark case runners, fit policy, branch ladders, and the current implementation behind `spectraxgk.benchmarks` | small public `spectraxgk.benchmarks` facade plus root `benchmarks/` drivers and `tests/validation/benchmarks` policy tests |
...
| --- | ---: | ---: | --- |
| Installable source Python files | 310 | <= 100 | Move validation/campaign code out of `src`; consolidate domain modules. |
...
| `src/spectraxgk/validation` package | 35 | 0-5 | Remove installable validation campaigns; keep only tiny public metric helpers if necessary. |
