...
- Installed package: 288 Python files and about 101.3k LOC. The main blockers
  are `validation/benchmarks` (12 files), `objectives` (41 files),
...
| --- | ---: | --- |
| `src/spectraxgk` | 288 Python files, about 101.3k LOC | installable package still contains benchmark validation policy plus many public/internal facades |
| `src/spectraxgk/validation` | 13 Python files, about 13.8k LOC | benchmark validation policy is still installed as runtime code |
...
- The active topology is `src/spectraxgk`: 288 Python files,
