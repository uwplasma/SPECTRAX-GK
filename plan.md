...
| Advanced collision operators | 100% scoped | The equal-species research boundary has independent drift-kinetic and finite-:math:`b` equation, dissipation, asymptotic, AD, conductivity, slab-ITG, and collisional-zonal gates. Exact Coulomb coefficients and original/improved-Sugama field terms are generated at arbitrary retained order with provenance and nested quadrature checks. The P21/J8-to-P24/J10 physical traces pass the fixed 5% moment gate, and the complete P24/J10 Figures 12--14 protocol passes through :math:`t\nu=30`: Xiao residual, original < improved < Coulomb finite-wavelength tails, improved early-window proximity to Coulomb, and both velocity sections. The compact replay artifact recomputes every verdict. Unequal-species drift-kinetic pairs remain validated, but arbitrary finite-:math:`b` multispecies coefficients are explicitly future scope; therefore the closed equal-species Python research path is not mislabeled as a production TOML model. |
