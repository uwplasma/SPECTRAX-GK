...
| Source consolidation | 97% | The 223-file/zero-exception architecture gate passes after deleting redundant solver-gradient and QA-objective facades, merging nonlinear Laguerre transforms into their velocity-basis owner, and reducing VMEC/Boozer line-search duplication. The package has roughly 88.4k lines and two modules exactly at the 1,000-line ceiling; reduce those owners without adding compatibility facades. |
