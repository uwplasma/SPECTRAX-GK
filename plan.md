...
- 2026-07-16: Closed the arbitrary-order equal-temperature improved-Sugama
  ...
  normalized driven response, not yet
  absolute Spitzer--Härm conductivity; dimensional collision-time and
  field-amplitude saturation remain the next closure.
...
- 2026-07-16: Extended the converged response to the arbitrary-order,
  ...
  high-charge gates fail closed on this Figure-16 ordering. The subsequent
  log entry closes the improved hierarchy; absolute conductivity normalization
  remains open.
...
- 2026-07-16: Closed the normalized drift-kinetic Coulomb response hierarchy.
  ...
  conductivity remains open pending matched dimensional normalization and
  saturation/field-amplitude checks. A separate post-release nonlinear Landau plan follows
