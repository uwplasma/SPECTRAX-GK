...
| Source consolidation | 96% | The 224-file/zero-exception architecture gate passes after deleting the redundant solver-gradient facade and merging nonlinear Laguerre transforms into their velocity-basis owner. The package still has roughly 89k lines and three modules exactly at the 1,000-line ceiling; reduce those owners without adding compatibility facades. |
