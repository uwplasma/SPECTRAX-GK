...
| Source consolidation | 97% | The 223-file/zero-exception architecture gate passes after deleting redundant solver-gradient and QA-objective facades, merging nonlinear Laguerre transforms into their velocity-basis owner, and reducing VMEC/Boozer line-search and nonlinear-promotion-policy duplication. The package has roughly 88.4k lines and one module exactly at the 1,000-line ceiling; reduce that owner without adding compatibility facades. |
