...
- 2026-07-16: Audited the finite-:math:`b` collisional-ITG plan against the
  ...
  reduces it again to 15.3 s without changing the equation-level result. The next
  :math:`(5,2)` hierarchy point takes 75.4 s on four wavelengths and lowers the
