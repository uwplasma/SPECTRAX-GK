...
| Structured solver ownership | 97% | Dtype-aware Arnoldi breakdown and true shifted-system residual retries close false convergence. A retained-Ritz approximation without ordered Schur compression was physically rejected; a true branch-preserving Krylov--Schur/Jacobi--Davidson route or field-coupled preconditioner remains before broad KBM branch promotion. |
