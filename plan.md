...
- 2026-07-16: Replaced equation (A4)'s six-deep combinatorial basis-transform
  ...
  complete 139-test artifact owner, and all table checksums pass. The
  two-wavelength :math:`(5,2)` build falls from 26.41 s to 16.00 s; the exact
