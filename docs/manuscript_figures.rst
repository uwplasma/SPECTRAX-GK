...
.. list-table::
   ...
   * - Eigenfunction validation panel
     - ``tools/artifacts/plot_eigenfunction_overlap_summary.py``, ``tools/artifacts/plot_eigenfunction_reference_overlay.py``, ``tools/generate_kbm_reference_overlay.py``, and ``tools/generate_w7x_reference_overlay.py``
   ...
   * - Zonal-flow / GAM response panel
     - ``tools/artifacts/plot_zonal_flow_response.py``, ``tools/artifacts/plot_zonal_flow_response_from_output.py``, ``tools/generate_miller_zonal_response_pilot.py``, ``tools/generate_w7x_zonal_response_panel.py``, ``tools/digitize_w7x_zonal_reference.py``, ``tools/comparison/compare_w7x_zonal_reference.py``, ``tools/artifacts/plot_w7x_zonal_contract_audit.py``, ``tools/artifacts/plot_w7x_zonal_moment_tail_audit.py``, ``tools/artifacts/plot_w7x_zonal_closure_ladder.py``, ``tools/artifacts/plot_w7x_zonal_state_convention_audit.py``, and ``tools/artifacts/plot_w7x_zonal_recurrence_sweep.py``
     - Open
