...
.. list-table::
   ...
   * - True ``t=1500`` strict QA matched nonlinear audits
     - ``tools/artifacts/build_external_vmec_replicate_ensemble.py`` and ``tools/release/check_nonlinear_transport_gates.py runtime-outputs``
