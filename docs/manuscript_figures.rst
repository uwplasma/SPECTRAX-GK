...
.. list-table::
   ...
   * - W7-X exact-state convention audit
     - ``tools/campaigns/run_exact_state_audit.py`` and ``tools/artifacts/plot_w7x_exact_state_audit.py``
     - Closed
   ...
   * - Windowed-statistics summary
     - ``tools/artifacts/plot_nonlinear_window_statistics.py``
   ...
   * - VMEC-state nonlinear-gradient launch runbook
     - ``tools/campaigns/design_nonlinear_gradient_ql_seed_screen.py``, ``tools/campaigns/design_nonlinear_gradient_state_control_runbook.py``, ``tools/campaigns/write_vmec_state_to_input_mapping_campaign.py``, ``tools/campaigns/write_vmec_asymmetric_state_to_input_mapping_campaign.py``, ``tools/campaigns/write_vmec_state_control_short_bracket_launch.py``, and ``tools/artifacts/build_vmec_state_to_input_mapping_response.py``
   ...
   * - Nonlinear-gradient control-variate campaign
     - ``tools/artifacts/build_nonlinear_gradient_variance_reduction_plan.py`` and ``tools/campaigns/write_nonlinear_gradient_control_variate_campaign.py``
   ...
   * - Open research lane status
     - ``tools/artifacts/build_open_research_lane_status.py``
   ...
   * - Manuscript-readiness status panel
     - ``tools/artifacts/build_manuscript_readiness_status.py``
   ...
   * - Aspect-6 QA low-turbulence optimization comparison
     - ``tools/artifacts/build_qa_low_turbulence_comparison.py`` and ``tools/artifacts/build_qa_low_turbulence_time_horizon_audit.py``
   ...
   * - Quasilinear spectrum panel
     - ``tools/artifacts/plot_quasilinear_spectrum.py``
   ...
   * - Quasilinear calibration audit
     - ``tools/artifacts/build_quasilinear_calibration_report.py`` and ``tools/artifacts/plot_quasilinear_calibration.py``
   ...
   * - Shape-aware quasilinear saturation diagnostic
     - ``tools/artifacts/plot_quasilinear_shape_aware_saturation.py``
   ...
   * - Quasilinear candidate regularization audit
     - ``tools/artifacts/plot_quasilinear_candidate_regularization_sweep.py``
   ...
   * - Stellarator quasilinear usefulness summary
     - ``tools/artifacts/plot_quasilinear_stellarator_usefulness.py``
   ...
   * - Quasilinear screening and rank-correlation skill
     - ``tools/artifacts/plot_quasilinear_screening_skill.py``
   ...
   * - Quasilinear dataset-sufficiency gate
     - ``tools/artifacts/plot_quasilinear_dataset_sufficiency.py``
   ...
   * - Quasilinear model-selection status
     - ``tools/artifacts/plot_quasilinear_model_selection_status.py`` and :mod:`spectraxgk.validation.quasilinear.model_selection`
   ...
   * - External-VMEC next-holdout runbook
     - ``tools/artifacts/build_external_vmec_holdout_runbook.py`` and :mod:`spectraxgk.validation.external_holdout`
   ...
   * - Pre-manuscript closure action runbook
     - ``tools/artifacts/build_pre_manuscript_closure_runbook.py``
   ...
   * - Quasilinear spectrum-shape gate
     - ``tools/artifacts/plot_quasilinear_spectrum_shape_gate.py``
   ...
   * - Zonal-flow / GAM response panel
     - ``tools/artifacts/plot_zonal_flow_response.py``, ``tools/artifacts/plot_zonal_flow_response_from_output.py``, ``tools/artifacts/generate_miller_zonal_response_pilot.py``, ``tools/artifacts/generate_w7x_zonal_response_panel.py``, ``tools/artifacts/digitize_w7x_zonal_reference.py``, ``tools/comparison/compare_w7x_zonal_reference.py``, ``tools/artifacts/plot_w7x_zonal_contract_audit.py``, ``tools/artifacts/plot_w7x_zonal_moment_tail_audit.py``, ``tools/artifacts/plot_w7x_zonal_closure_ladder.py``, ``tools/artifacts/plot_w7x_zonal_state_convention_audit.py``, and ``tools/artifacts/plot_w7x_zonal_recurrence_sweep.py``
     - Open
   ...
   * - W7-X fluctuation-spectrum panel
     - ``tools/artifacts/plot_w7x_fluctuation_spectrum_panel.py`` and ``tools/artifacts/build_w7x_tem_extension_status.py``
...
.. list-table::
   ...
   * - Solver-objective geometry-gradient gate
     - ``tools/artifacts/build_solver_objective_gradient_gate.py``, ``tools/artifacts/build_vmec_boozer_solver_frequency_gradient_gate.py``, ``tools/artifacts/build_vmec_boozer_quasilinear_gradient_gate.py``, ``tools/artifacts/build_vmec_boozer_nonlinear_window_gradient_gate.py``, ``tools/artifacts/build_vmec_boozer_gradient_holdout_matrix.py``, ``tools/artifacts/build_vmec_boozer_multi_point_objective_gate.py``, ``tools/artifacts/build_vmec_boozer_aggregate_line_search_comparison.py``, ``tools/artifacts/build_vmec_boozer_aggregate_alpha_holdout_gate.py``, ``tools/artifacts/build_vmec_boozer_aggregate_surface_holdout_gate.py``, ``tools/artifacts/build_vmec_boozer_second_equilibrium_aggregate_gate.py``, ``tools/release/check_vmec_boozer_aggregate_holdout_gate.py``, ``tools/release/check_production_nonlinear_optimization_guard.py``, ``tools/artifacts/build_nonlinear_window_fd_audit.py``, and ``tools/artifacts/build_vmec_boozer_nonlinear_window_fd_audit.py``
   ...
   * - True ``t=1500`` strict QA matched nonlinear audits
     - ``tools/artifacts/build_external_vmec_replicate_ensemble.py`` and ``tools/release/check_nonlinear_runtime_outputs.py``
   ...
   * - Full max-mode-5 QA transport optimizer sweep
     - ``tools/artifacts/build_vmec_jax_qa_full_sweep_panel.py`` from office
   ...
   * - Boundary-coefficient transport landscape
     - ``tools/artifacts/build_vmec_boundary_transport_landscape.py`` and ``tools/campaigns/patch_vmec_jax_wout_metadata.py``
   ...
   * - VMEC/Boozer parity matrix
     - ``tools/artifacts/build_vmec_boozer_parity_matrix.py``
