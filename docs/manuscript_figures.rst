...
.. list-table::
   ...
   * - Boundary-coefficient transport landscape
     - ``tools/artifacts/build_vmec_boundary_transport_landscape.py`` and ``tools/patch_vmec_jax_wout_metadata.py``
