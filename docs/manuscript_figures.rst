...
nonlinear turbulent-flux stellarator optimization is partial at ``82.9%``;
...
is ``84.5%``. These percentages are strict closure metrics for the current
