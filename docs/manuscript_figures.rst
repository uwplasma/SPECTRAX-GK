...
.. list-table::
   ...
   * - Eigenfunction validation panel
     - ``tools/artifacts/plot_eigenfunction_diagnostics.py overlap-summary``, ``tools/artifacts/plot_eigenfunction_diagnostics.py reference-overlay``, ``tools/artifacts/generate_kbm_reference_overlay.py``, and ``tools/artifacts/generate_w7x_reference_overlay.py``
