...
.. list-table::
   ...
   * - Nonlinear-gradient control-variate campaign
     - ``tools/artifacts/build_nonlinear_gradient_evidence.py variance-plan`` and ``tools/campaigns/write_nonlinear_gradient_control_variate_campaign.py``
   ...
   * - Velocity-space convergence panel
     - ``tools/artifacts/generate_linear_validation_gates.py observed-order`` plus dedicated full convergence refresh script to add
     - Open
...
.. list-table::
   ...
   * - Solver-objective geometry-gradient gate
     - ``tools/artifacts/build_solver_objective_gradient_gate.py``, ``tools/artifacts/build_vmec_boozer_gradient_gate.py frequency``, ``tools/artifacts/build_vmec_boozer_gradient_gate.py quasilinear``, ``tools/artifacts/build_vmec_boozer_gradient_gate.py nonlinear-window``, ``tools/artifacts/build_vmec_boozer_gradient_holdout_matrix.py``, ``tools/artifacts/build_vmec_boozer_multi_point_objective_gate.py``, ``tools/artifacts/build_vmec_boozer_aggregate_line_search_comparison.py``, ``tools/artifacts/build_vmec_boozer_aggregate_holdout_gate.py alpha``, ``tools/artifacts/build_vmec_boozer_aggregate_holdout_gate.py surface``, ``tools/artifacts/build_vmec_boozer_second_equilibrium_aggregate_gate.py``, ``tools/release/check_vmec_boozer_aggregate_holdout_gate.py``, ``tools/release/check_production_nonlinear_optimization_guard.py``, ``tools/artifacts/build_nonlinear_window_fd_audit.py``, and ``tools/artifacts/build_vmec_boozer_nonlinear_window_fd_audit.py``
