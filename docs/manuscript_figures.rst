...
.. list-table::
   ...
   * - W7-X exact-state convention audit
     - ``tools/run_exact_state_audit.py`` and ``tools/artifacts/plot_w7x_exact_state_audit.py``
     - Closed
   ...
   * - Nonlinear-gradient control-variate campaign
     - ``tools/artifacts/build_nonlinear_gradient_variance_reduction_plan.py`` and ``tools/write_nonlinear_gradient_control_variate_campaign.py``
