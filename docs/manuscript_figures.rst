...
.. list-table::
   ...
   * - Zonal-flow / GAM response panel
     - ``tools/artifacts/build_zonal_flow_artifacts.py`` (``response-csv``, ``response-output``, and ``objective-gate`` modes), ``tools/artifacts/generate_miller_zonal_response_panel.py``, ``tools/artifacts/generate_w7x_zonal_response_panel.py``, ``tools/artifacts/digitize_w7x_zonal_reference.py``, ``tools/comparison/compare_w7x_zonal_reference.py``, ``tools/artifacts/build_w7x_zonal_validation_artifacts.py`` (``contract`` and ``state-convention`` modes), ``tools/artifacts/build_w7x_zonal_recurrence_artifacts.py moment-tail``, ``tools/artifacts/plot_w7x_zonal_closure_ladder.py``, and ``tools/artifacts/build_w7x_zonal_recurrence_artifacts.py sweep``
     - Open
