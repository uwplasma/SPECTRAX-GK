...
``runtime.py`` and ``cli.py``
  ...
  this facade now covers the maintained full-GK executable workflows only.
...
Phase 1: introduce protocols and containers
  ...
  ``spectraxgk.diagnostics.quasilinear_model_selection`` owns the scoped
  ...
  ``spectraxgk.diagnostics.quasilinear_model_selection``.
