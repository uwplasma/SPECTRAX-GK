...
``tools/artifacts/plot_nonlinear_window_statistics.py`` from the frozen gate-summary JSON
...
``tools/profiling/profile_nonlinear_sharding.py``. That closes the control-flow and
