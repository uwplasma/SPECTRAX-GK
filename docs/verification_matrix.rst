...
final-state identity layer for the pjit state-sharded scan. True nonlinear
domain decomposition with halo/FFT communication, conservation checks, and
benchmark-size speedup remains outside the release claim.
