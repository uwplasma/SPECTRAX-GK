...
- 341 Python source files under ``src/spectraxgk`` after consolidating
  nonlinear transport-window and quasilinear-calibration diagnostics.
- 73 Python files under ``src/spectraxgk/validation``.
