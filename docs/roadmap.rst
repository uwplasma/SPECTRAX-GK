...
``tools/artifacts/build_open_research_lane_status.py``. The generated artifact is a
...
``tools/artifacts/build_manuscript_readiness_status.py`` because W7-X zonal recurrence
...
dashboard generated by ``tools/artifacts/build_pre_manuscript_closure_status.py``. This
