...
``tools/artifacts/build_research_status.py open-lanes``. The generated artifact is a
...
``tools/artifacts/build_research_status.py manuscript-readiness`` because W7-X zonal recurrence
...
dashboard generated by ``tools/artifacts/build_research_status.py pre-manuscript-closure``. This
