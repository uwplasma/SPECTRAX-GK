...
`python tools/artifacts/generate_parallel_identity_gate.py ky-scan`. It runs the real Cyclone
...
`python tools/artifacts/gate_laguerre_nonlinear_modes.py` for their production case
