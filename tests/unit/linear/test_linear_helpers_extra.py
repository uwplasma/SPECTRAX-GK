...
def test_integrate_linear_wrapper_enables_electrostatic_field_specialization(
    ...
    monkeypatch.setattr(
        "spectraxgk.solvers.linear.integrators._integrate_linear_cached", _fake_cached
    )
...
def test_linear_rhs_parallel_cached_serial_alias_and_error_branches(
    ...
    monkeypatch.setattr(
        "spectraxgk.operators.linear.rhs.linear_rhs_cached", _fake_serial
    )
...
def test_integrate_linear_cached_impl_uses_parallel_rhs(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "spectraxgk.solvers.linear.integrators.linear_rhs_parallel_cached",
        _fake_parallel_rhs,
    )
