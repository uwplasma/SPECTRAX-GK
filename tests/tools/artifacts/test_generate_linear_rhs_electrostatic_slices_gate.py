...
from tools.artifacts import generate_linear_rhs_electrostatic_slices_gate as gate


def test_linear_rhs_electrostatic_slices_gate_builds_identity_summary(
    monkeypatch,
) -> None:
    class FakePlan:
        def to_dict(self):
