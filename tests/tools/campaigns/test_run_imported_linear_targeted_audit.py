...
from tools.campaigns.run_imported_linear_targeted_audit import build_parser
...
def test_run_imported_linear_targeted_audit_parser_accepts_inner_cache_controls(
    tmp_path: Path,
) -> None:
    out = tmp_path / "combined.csv"
    args = build_parser().parse_args(
...
def test_run_imported_linear_targeted_audit_parser_accepts_project_mode_method(
    tmp_path: Path,
) -> None:
    out = tmp_path / "combined.csv"
    args = build_parser().parse_args(
