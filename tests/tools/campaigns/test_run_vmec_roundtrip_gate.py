...
from tools.campaigns.run_vmec_roundtrip_gate import _resolve_manifest_path, build_parser
...
def test_vmec_roundtrip_office_manifest_w7x_config_resolves_to_real_example() -> None:
    repo = Path(__file__).resolve().parents[3]
    manifest = repo / "tools" / "vmec_roundtrip_lanes.office.toml"
