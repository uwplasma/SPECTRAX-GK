...
SCRIPT = ROOT / "tools" / "gate_linear_rhs_zero_norm_state_window.py"
spec = importlib.util.spec_from_file_location("gate_linear_rhs_zero_norm_state_window", SCRIPT)
...
def test_build_summary_accepts_collision_skip_and_rejects_hypercollision_skip() -> None:
    ...
    assert payload["candidates"]["hypercollisions"]["safe_to_disable_over_window"] is False
