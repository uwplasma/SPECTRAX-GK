...
def test_w7x_combined_trace_loader_rejects_missing_and_absent_kx(tmp_path: Path) -> None:
...
def test_reference_tables_reject_missing_columns_and_missing_trace(tmp_path: Path) -> None:
