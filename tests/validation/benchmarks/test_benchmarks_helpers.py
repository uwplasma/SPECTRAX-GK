...
def test_select_fit_signal_and_auto(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "spectraxgk.diagnostics.growth_rates.extract_mode_time_series",
    ...
    monkeypatch.setattr(
        "spectraxgk.diagnostics.growth_rates._score_fit_signal_auto",
        fake_score,
    )
...
def test_score_fit_signal_auto_filters_invalid(monkeypatch) -> None:
    ...
    monkeypatch.setattr(
        "spectraxgk.diagnostics.growth_rates.fit_growth_rate_auto_with_stats",
        _fake_fit,
    )
