"""Internal VMEC imported-geometry pipeline.

The primary public entry point is ``generate_vmec_eik_internal``.  The implementation preserves archived VMEC flux-tube reference conventions so numerical parity can be verified variable by variable.
"""
