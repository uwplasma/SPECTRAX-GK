...
def _pack_resolved_diagnostics(resolved_t: tuple[np.ndarray, ...]) -> ResolvedDiagnostics:
    return ResolvedDiagnostics(
        ...
        Wg_kxst=resolved_t[8],
        Wg_kyst=resolved_t[9],
        Wg_kxkyst=resolved_t[10],
        Wg_zst=resolved_t[11],
        Wg_lmst=resolved_t[12],
        Wphi_kxst=resolved_t[13],
        Wphi_kyst=resolved_t[14],
        Wphi_kxkyst=resolved_t[15],
        Wphi_zst=resolved_t[16],
        Wapar_kxst=resolved_t[17],
        Wapar_kyst=resolved_t[18],
        Wapar_kxkyst=resolved_t[19],
        Wapar_zst=resolved_t[20],
        HeatFlux_kxst=resolved_t[21],
        HeatFlux_kyst=resolved_t[22],
        HeatFlux_kxkyst=resolved_t[23],
        HeatFlux_zst=resolved_t[24],
        HeatFluxES_kxst=resolved_t[25],
        HeatFluxES_kyst=resolved_t[26],
        HeatFluxES_kxkyst=resolved_t[27],
        HeatFluxES_zst=resolved_t[28],
        HeatFluxApar_kxst=resolved_t[29],
        HeatFluxApar_kyst=resolved_t[30],
        HeatFluxApar_kxkyst=resolved_t[31],
        HeatFluxApar_zst=resolved_t[32],
        HeatFluxBpar_kxst=resolved_t[33],
        HeatFluxBpar_kyst=resolved_t[34],
        HeatFluxBpar_kxkyst=resolved_t[35],
        HeatFluxBpar_zst=resolved_t[36],
        ParticleFlux_kxst=resolved_t[37],
        ParticleFlux_kyst=resolved_t[38],
        ParticleFlux_kxkyst=resolved_t[39],
        ParticleFlux_zst=resolved_t[40],
        ParticleFluxES_kxst=resolved_t[41],
        ParticleFluxES_kyst=resolved_t[42],
        ParticleFluxES_kxkyst=resolved_t[43],
        ParticleFluxES_zst=resolved_t[44],
        ParticleFluxApar_kxst=resolved_t[45],
        ParticleFluxApar_kyst=resolved_t[46],
        ParticleFluxApar_kxkyst=resolved_t[47],
        ParticleFluxApar_zst=resolved_t[48],
        ParticleFluxBpar_kxst=resolved_t[49],
        ParticleFluxBpar_kyst=resolved_t[50],
        ParticleFluxBpar_kxkyst=resolved_t[51],
        ParticleFluxBpar_zst=resolved_t[52],
        TurbulentHeating_kxst=resolved_t[53],
        TurbulentHeating_kyst=resolved_t[54],
        TurbulentHeating_kxkyst=resolved_t[55],
        TurbulentHeating_zst=resolved_t[56],
    )
