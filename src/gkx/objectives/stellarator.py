...
from gkx.objectives import stellarator_tables as _stellarator_tables
from gkx.objectives.stellarator_tables import (
...
from gkx.objectives.autodiff_validation import autodiff_finite_difference_report
...
def stellarator_itg_vmec_boozer_sample_objective_table_from_state(
    ...
    **vmec_boozer_options: Any,
    ...
    """Facade wrapper for real VMEC/Boozer/GKX objective rows."""
...
def stellarator_itg_vmec_boozer_portfolio_objective_from_state(
    ...
    **vmec_boozer_options: Any,
    ...
    """Facade wrapper for the real VMEC/Boozer/GKX portfolio scalar."""
